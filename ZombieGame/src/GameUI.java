...
public class GameUI {
    ...
    public void createUI() {
        // Initialize the backpack used by the ItemGUI specifically
        ItemGUI.backpack = new Item();
        ItemGUI.backpack.createItemInventory();
        ...
        btnItems.addActionListener(e -> {
            ig = new ItemGUI(); //show the item/inventory screen
        });
        /************************************/
...
/************************************************/
        ...
        mapInteract.addActionListener(e -> {
            ...
            ItemGUI.backpack.pushItem(loot); // PUSH it into the inventory
        });
